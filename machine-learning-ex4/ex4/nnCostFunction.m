...
%--------------part 1:  Feedforword cost function
k = num_labels;
Y = eye(k)(y,:);
...
J = (1/m) * sum(cost);% cost function without regularization
...
%-------------part 3:   Neual Net Gradient Function (Backpropagation)

Delta1 = 0;
Delta2 = 0;

for t=1:m 
	%sstep 1 input values
	a1 = [1; X(t, :)'];
	z2 = Theta1 * a1;
	a2 = [1; sigmoid(z2)];
